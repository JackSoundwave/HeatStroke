...
public class EnemyAI : MonoBehaviour
{
    ...
    private void FindPathToDefense()
    {
        DefenceStructure Defense = FindObjectOfType<DefenceStructure>();
        //Debug.Log("Player value: " + player);
        ...
        if (Defense != null)
        {
            ...
            pathfinder.FindPath(enemyUnit.activeTile, Defense.activeTile, inRangeTiles);
            //This grabs the neighbourtiles of the player unit, using the instance2 variable declared in the MapManager script
            List<HideAndShowScript> playerNeighbourtiles = MapManager.instance2.getNeighbourTiles(Defense.activeTile, inRangeTiles);
